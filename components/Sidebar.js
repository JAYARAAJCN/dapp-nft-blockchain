...
import nftLogoFull from '../assets/logo_full1.png'
...
const Sidebar = () => { 
    const styles ={
        container: `h-full w-[300px] lex flex-col bg-[#fff] static`,
        ...
        nftLogo: `mr-4 flex object-cover`,
        ...
        <div className={styles.container}>
            <div className={styles.profile}>
                ...
                <div className={styles.companyName}>
                    <Image src={nftLogoFull} alt='nftlogo' height={100} width={100}/>
                </div>
        </div>
    )
}
